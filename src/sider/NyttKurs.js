...
import {createHendelse, createKurs} from "../graphql/mutations";
...
const NyttKurs = () => {
    ...
    async function lastopp() {
        ...
        try {
            ...
            const newKurs = await client.graphql({
                query: createKurs,
                variables: {
                    input: {
                        "kursholder": kursholder,
                        "kursHendelseId": newHendelse.data.createHendelse.id,
                    }
                }
            });
            console.log("Trening laget", newKurs)
            navigate('/kurs?id=' + newKurs.data.createKurs.id.toString());
        ...
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <button type="submit">Lag nytt kurs</button>
                </div>
            </form>
        </div>
    );
