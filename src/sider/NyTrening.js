...
import { createTrening, createHendelse } from '../graphql/mutations';
...
const NyTrening = () => {
    ...
    async function lastopp() {
        ...
        try {
            ...
            const newTrening = await client.graphql({
                query: createTrening,
                variables: {
                    input: {
                        "treningHendelseId": newHendelse.data.createHendelse.id,
                    }
                }
            });
            console.log("Trening laget", newTrening)
            navigate('/trening?id=' + newTrening.data.createTrening.id.toString());
        ...
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <button type="submit">Lag ny trening</button>
                </div>
            </form>
        </div>
    );
