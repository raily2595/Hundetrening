...
import { createKurs } from "../graphql/mutations";
const client = generateClient();
export default function KursCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setKursholder(initialValues.kursholder);
    setErrors({});
  };
  const validations = {
    kursholder: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createKurs.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "KursCreateForm")}
      {...rest}
    >
      <TextField
        label="Kursholder"
